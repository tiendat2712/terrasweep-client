...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="mt-20 w-full bg-white border-t border-zinc-200 text-zinc-700">
      {/* ========================================================================= */}
      {/* 1. BRAND VALUE PILLARS (ANCHORED FOR "WHY US")                           */}
      {/* ========================================================================= */}
      ...
      <div id="about-section" className="w-full">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
            ...
            {/* Col 1: Brand Philosophy & Concierge Contact */}
            <div className="space-y-4">
              <div className="space-y-2.5">
                <div className="flex items-center gap-2.5 sm:gap-3">
                  <div className="relative w-9 h-9 sm:w-10 sm:h-10 flex items-center justify-center shrink-0 overflow-hidden">
                    <img
            ...
            <div className="space-y-5">
              <div>
                ...
                {/* Authentic Vector Payment Logos */}
                <div className="grid grid-cols-3 gap-2">
                  {/* 1. Visa Official Vector */}
                  <div className="h-10 rounded-xl bg-zinc-50/90 hover:bg-white border border-zinc-200 flex items-center justify-center p-2 shadow-2xs transition-colors" title="Visa">
                  ...
                  <div className="h-10 rounded-xl bg-zinc-50/90 hover:bg-white border border-zinc-200 flex items-center justify-center p-2 shadow-2xs transition-colors" title="Mastercard">
                  ...
                  <div className="h-10 rounded-xl bg-zinc-50/90 hover:bg-white border border-zinc-200 flex items-center justify-center p-1.5 shadow-2xs transition-colors" title="JCB Card">
                  ...
                  <div className="h-10 rounded-xl bg-zinc-50/90 hover:bg-white border border-zinc-200 flex items-center justify-center px-2 py-1 shadow-2xs transition-colors" title="Apple Pay">
                  ...
                  <div className="h-10 rounded-xl bg-zinc-50/90 hover:bg-white border border-zinc-200 flex items-center justify-center px-2 py-1 shadow-2xs transition-colors" title="Ví MoMo">
                  ...
                  <div className="h-10 rounded-xl bg-zinc-50/90 hover:bg-white border border-zinc-200 flex items-center justify-center px-2.5 py-1 shadow-2xs transition-colors" title="Thanh toán khi nhận hàng (COD)">
                    <div className="flex items-center gap-1.5">
      ...
      {/* ========================================================================= */}
      <div className="w-full bg-[#FAFAFA] border-t border-zinc-200/80 py-6 pb-20 sm:pb-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-zinc-500 font-sans">
          <p className="text-center md:text-left leading-relaxed">
            © 2026 TerraSweep Vietnam Inc. {t('footer.businessLicense')}
          </p>

          {/* Links With Inline Bullet Connectors (Never Orphaned) */}
          <div className="flex flex-wrap items-center justify-center gap-x-2.5 gap-y-1 text-zinc-600 text-xs">
            <a href="#about-section" className="hover:text-black transition-colors">{t('footer.policyPrivacy')}</a>
            <span className="text-zinc-300">•</span>
            <a href="#about-section" className="hover:text-black transition-colors">{t('footer.policyOperating')}</a>
            <span className="text-zinc-300">•</span>
            <a href="#about-section" className="hover:text-black transition-colors">{t('footer.policyShipping')}</a>
            <span className="text-zinc-300">•</span>
            <a href="#about-section" className="hover:text-black transition-colors">{t('footer.policyReturnRefund')}</a>
          </div>
